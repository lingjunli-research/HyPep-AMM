...
from user_input import raw_converter_path
...
raw_converter = pd.read_csv(raw_converter_path, sep=" ",skiprows=[0], names= ["m/z", "resolution", "charge", "intensity","MS2",'scan_number','precursor_charge','empty'])
